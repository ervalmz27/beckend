...
AWS Console
u:mesinlokal1@gmail.com
p:2TLV^.6CecxMa5N{

sdk
ssh -i focuson.pem ubuntu@13.251.114.140

docker build -t jekibus/buzzstrike .
docker push jekibus/buzzstrike


goto server
docker pull jekibus/buzzstrike
docker stop front
